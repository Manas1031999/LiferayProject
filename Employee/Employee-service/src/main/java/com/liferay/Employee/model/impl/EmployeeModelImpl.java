...
public class EmployeeModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"city", Types.VARCHAR}, {"status", Types.INTEGER}
	};
	...
	public static final String ORDER_BY_SQL =
		" ORDER BY Emp_Employee.empId ASC";
	...
	static {
		...
		attributeGetterFunctions.put("enrollmentNo", Employee::getEnrollmentNo);
		attributeSetterBiConsumers.put(
			"enrollmentNo",
			(BiConsumer<Employee, String>)Employee::setEnrollmentNo);
		...
		attributeGetterFunctions.put("contactNo", Employee::getContactNo);
		attributeSetterBiConsumers.put(
			"contactNo", (BiConsumer<Employee, String>)Employee::setContactNo);
	...
	public Object clone() {
		...
		employeeImpl.setEnrollmentNo(getEnrollmentNo());
		employeeImpl.setFirstName(getFirstName());
		employeeImpl.setLastName(getLastName());
		employeeImpl.setContactNo(getContactNo());
	...
	public CacheModel<Employee> toCacheModel() {
		...
		employeeCacheModel.enrollmentNo = getEnrollmentNo();

		String enrollmentNo = employeeCacheModel.enrollmentNo;

		if ((enrollmentNo != null) && (enrollmentNo.length() == 0)) {
			employeeCacheModel.enrollmentNo = null;
		}
		...
		employeeCacheModel.contactNo = getContactNo();

		String contactNo = employeeCacheModel.contactNo;

		if ((contactNo != null) && (contactNo.length() == 0)) {
			employeeCacheModel.contactNo = null;
		}
